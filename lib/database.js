...
module.exports = {
  ...
  update_coingecko_db: function(coin, cb) {
    coingecko.get_data(coin, function(err, obj) {
      ...
      Cg.update( { symbol: coin },
	{
          rank: obj.data.coingecko_rank,
          price_usd: obj.data['market_data']['current_price']['usd'],
          price_btc: obj.data['market_data']['current_price']['usd'],
          volume_24h_usd: obj.data.total_volume,
          market_cap_usd: obj.data.market_cap[usd],
          available_supply: obj.data.circulating_supply,
          total_supply: obj.data.total_supply,
          percent_change_1h: obj.data.price_change_percentage_1h_in_currency.usd,
          percent_change_24h: obj.data.price_change_percentage_24h_in_currency.usd,
          percent_change_7d: obj.data.price_change_percentage_7d_in_currency.usd,
          last_updated: obj.data.last_updated,
        },
	function() {
          Stats.update(
	    {coin:settings.coin},
            {last_price: obj.data.market_data.current_price.btc},
