...
module.exports = {
  ...
  update_coingecko_db: function(coin, cb) {
      ...
      Cg.update( { symbol: coin },
	{
          ...
          volume_24h_usd: obj.total_volume,
          market_cap_usd: obj.market_cap.usd,
          available_supply: obj.circulating_supply,
          total_supply: obj.total_supply,
          percent_change_1h: obj.price_change_percentage_1h_in_currency.usd,
          percent_change_24h: obj.price_change_percentage_24h_in_currency.usd,
          percent_change_7d: obj.price_change_percentage_7d_in_currency.usd,
	...
	function() {
	  ...
	  console.log(rank+" "+price_usd+" "+price_btc);
  },
