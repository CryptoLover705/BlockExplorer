...
module.exports = {
  ...
  update_coinmarketcap_db: function(coin, cb) {
	...
	{
          rank: obj.data.rank,
          price_usd: obj.data.quotes.USD.price,
          price_btc: obj.data.quotes.BTC.price,
          volume_24h_usd: obj.data.quotes.USD.volume_24h,
          market_cap_usd: obj.data.quotes.USD.market_cap,
          available_supply: obj.data.circulating_supply,
          total_supply: obj.data.total_supply,
          percent_change_1h: obj.data.quotes.BTC.percent_change_1h,
          percent_change_24h: obj.data.quotes.BTC.percent_change_24h,
          percent_change_7d: obj.data.quotes.BTC.percent_change_7d,
          last_updated: obj.data.last_updated,
        },
	function() {
          Stats.update(
	    {coin:settings.coin},
            {last_price: obj.data.quotes.BTC.price},
