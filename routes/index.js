        ...
        lib.get_masternodeonlinecount(function(activeMnCount) {
          db.get_latest_masternodestats(settings.symbol, function(mnStats) {
            ...
            var data = {
              ...
              marketCapUsd: formatCurrency(stats.supply * cg.price_usd, { maxFraction: 3 }),
              cg: cg,
              blockCount24h: -1,
              avgBlockTime: -1,
            ...
            lib.get_masternodeonlinecount(function(masternodeonlinecount){
              db.get_cg(settings.coingecko.ticker, function(cg){
                db.get_stats(settings.coin, function (stats) {
                  ...
                  res.send({ data: [{
                    difficulty: BigNumber((difficulty).toFixed(20)).toFormat(6),
          ...
          db.get_stats(settings.coin, function (stats) {
            db.get_latest_masternodestats(settings.symbol, function(mnStats) {
              ...
              var data = {
                ...
                market_cap_usd: formatCurrency(stats.supply * cg.price_usd, { maxFraction: 3 }),
